...
public class EntityTravelAgency extends AbstractBlockchain {
  ...
  public void deploy(
    ...
    LOG.info(
        ...
        this.blockchainId,
        this.travelAgency.getContractAddress());
  }
  ...
  public BigInteger book(final int date) throws Exception {
    ...
    try {
      TransactionReceipt txR =
          this.travelAgency.bookHotelAndTrain(BigInteger.valueOf(date), uniqueBookingId).send();
  ...
  public BigInteger separatedBookHotelAndTrain(int date) throws Exception {
    ...
    TransactionReceipt txr =
        this.travelAgency
            .separatedBookHotelAndTrain(BigInteger.valueOf(date), uniqueBookingId)
            .send();
