...
public class EntityBase extends AbstractBlockchain {
    ...
    public void deployContracts() throws Exception {
        ...
        this.erc20 = ERC20PresetFixedSupply.deploy(this.web3j, this.tm, this.gasProvider, name, symbol, TOKEN_SUPPLY, owner).send();

        LOG.info(" Deploy {} contract", this.entity);
        this.hotelContract = Hotel.deploy(this.web3j, this.tm, this.gasProvider, this.erc20.getContractAddress()).send();
    }
