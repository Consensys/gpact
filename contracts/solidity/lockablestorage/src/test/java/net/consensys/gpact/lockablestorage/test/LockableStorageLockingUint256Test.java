...
public class LockableStorageLockingUint256Test extends AbstractLockableStorageTest {
  ...
  public void commit() throws Exception {
    ...
    // Commit changes.
    this.lockableStorageContract.finalise(true, BigInteger.ONE, BigInteger.ZERO).send();
  ...
  public void ignore() throws Exception {
    ...
    // Commit changes.
    this.lockableStorageContract.finalise(false, BigInteger.ONE, BigInteger.ZERO).send();
