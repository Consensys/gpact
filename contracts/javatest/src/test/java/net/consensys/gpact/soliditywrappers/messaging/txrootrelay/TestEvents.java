...
public class TestEvents extends Contract {
  public static final String BINARY =
      "";

  public static final String FUNC_START = "start";

  public static final Event EVENT1_EVENT =
      new Event("Event1", Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
  ;

  public static final Event EVENT2_EVENT =
      new Event("Event2", Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
  ;

  public static final Event EVENT3_EVENT =
      new Event("Event3", Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
  ;

  @Deprecated
  protected TestEvents(
  ...
  public List<Event1EventResponse> getEvent1Events(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        extractEventParametersWithLog(EVENT1_EVENT, transactionReceipt);
  ...
  public Flowable<Event1EventResponse> event1EventFlowable(EthFilter filter) {
    return web3j
        ...
        .map(
            new Function<Log, Event1EventResponse>() {
              @Override
              public Event1EventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(EVENT1_EVENT, log);
                Event1EventResponse typedResponse = new Event1EventResponse();
  ...
  public Flowable<Event1EventResponse> event1EventFlowable(
  ...
  public List<Event2EventResponse> getEvent2Events(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        extractEventParametersWithLog(EVENT2_EVENT, transactionReceipt);
  ...
  public Flowable<Event2EventResponse> event2EventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, Event2EventResponse>() {
              @Override
              public Event2EventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(EVENT2_EVENT, log);
                Event2EventResponse typedResponse = new Event2EventResponse();
                typedResponse.log = log;
                typedResponse.id = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
                return typedResponse;
  ...
  public Flowable<Event2EventResponse> event2EventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public List<Event3EventResponse> getEvent3Events(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        extractEventParametersWithLog(EVENT3_EVENT, transactionReceipt);
  ...
  public Flowable<Event3EventResponse> event3EventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, Event3EventResponse>() {
              @Override
              public Event3EventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(EVENT3_EVENT, log);
                Event3EventResponse typedResponse = new Event3EventResponse();
                typedResponse.log = log;
                typedResponse.id = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
                return typedResponse;
  ...
  public Flowable<Event3EventResponse> event3EventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static RemoteCall<TestEvents> deploy(
  ...
  public static RemoteCall<TestEvents> deploy(
    ...
    return deployRemoteCall(
        TestEvents.class, web3j, transactionManager, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<TestEvents> deploy(
      ...
      BigInteger gasLimit) {
    return deployRemoteCall(
        TestEvents.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
  }
