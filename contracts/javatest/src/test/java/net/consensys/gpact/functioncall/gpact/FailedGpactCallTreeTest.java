  ...
  public void testFailingRootAndSegments() throws Exception {
    ...
    private void deployContracts() throws Exception {
      LOG.info("****** Deploy Contracts *******");
        ...
        this.intermediateBlockchain =
                new FailTestContractManager("intermediate", appCreds, bc2);
...
//        LOG.info(" Intermediate revert reason: {}", RevertReason.decodeRevertReason(intermediateTxr.getRevertReason()));
//      }
//
...
//        LOG.info(" Leaf revert reason: {}", RevertReason.decodeRevertReason(leafTxr.getRevertReason()));
//      }
//    }
