...
public class EventRelayAppTest extends Contract {
  public static final String BINARY =
      "";
  ...
  public static final Event DUMP_EVENT =
      new Event("Dump", Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
  ;

  @Deprecated
  protected EventRelayAppTest(
  ...
  public String getABI_val() {
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            FUNC_VAL, Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
    return org.web3j.abi.FunctionEncoder.encode(function);
  }

  @Deprecated
  public static EventRelayAppTest load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
  ...
  public static RemoteCall<EventRelayAppTest> deploy(
      Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
    return deployRemoteCall(
        EventRelayAppTest.class, web3j, credentials, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<EventRelayAppTest> deploy(
    ...
    return deployRemoteCall(
        EventRelayAppTest.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
  }

  public static RemoteCall<EventRelayAppTest> deploy(
      Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    return deployRemoteCall(
        EventRelayAppTest.class, web3j, transactionManager, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<EventRelayAppTest> deploy(
      ...
      BigInteger gasLimit) {
    return deployRemoteCall(
        EventRelayAppTest.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
  }
