...
import "./MappingPauser.sol";

abstract contract CbcDecVer2 is MappingPauser {
    bytes32 public constant VERIFIER_MAPPING_ROLE = keccak256("VERIFIER_MAPPING_ROLE");

    modifier onlyVerifierMapper() {
        require(
            hasRole(VERIFIER_MAPPING_ROLE, _msgSender()),
            "Must have VERIFIER MAPPING role"
        );
        _;
    }
    ...
    constructor() {
        ...
        _setupRole(VERIFIER_MAPPING_ROLE, sender);
    }
    ...
    function decodeAndVerifyEvent(
        ...
        require(
            _cbcAddress == remoteBridgeContracts[_blockchainId],
