...
public class GpactV1CrossControlManagerGroup extends GpactCrossControlManagerGroup {

  public GpactV1CrossControlManagerGroup() {
    super(GpactVersion.V1);
  }
  ...
  protected GpactCrossControlManager newGpactCrossControlManager(
    ...
    return new GpactV1CrossControlManager(credentials, bcConfig);
  }
}
