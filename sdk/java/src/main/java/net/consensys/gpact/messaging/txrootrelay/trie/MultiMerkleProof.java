...
/**
 * An in-memory MultiMerkleProof. This is a sub-structure of MerklePatriciaTrie with additional
 * MerkleProofHashNode's. Given a sequence of key value pairs, and a root hash, the instance of this
 * class can be used as an evidence that the key value paris indeed belong to the trie pointed by
 * the root hash.
 *
...
public class MultiMerkleProof<V> {
  ...
  public void printStats() {
    ...
    LOG.info(
        "#Hashes = {}, #Extension nodes = {}, #Branch nodes = {}",
        statsVisitor.getNumHashes(),
        statsVisitor.getNumExtensions(),
        statsVisitor.getNumBranches());
  }
