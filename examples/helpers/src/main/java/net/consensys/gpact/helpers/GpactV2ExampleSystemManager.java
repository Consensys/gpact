...
public class GpactV2ExampleSystemManager extends GpactExampleSystemManager {
  static final Logger LOG = LogManager.getLogger(GpactV2ExampleSystemManager.class);

  public GpactV2ExampleSystemManager(String propertiesFileName) {
