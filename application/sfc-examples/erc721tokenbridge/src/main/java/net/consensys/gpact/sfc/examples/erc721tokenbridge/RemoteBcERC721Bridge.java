...
public class RemoteBcERC721Bridge extends AbstractERC721Bridge {
    ...
    public static final byte[] MINTER_ROLE = Hash.keccak256(Bytes.wrap("MINTER_ROLE".getBytes())).toArray();


    ERC721RemoteBlockchain erc721;


    public RemoteBcERC721Bridge(final String entity,
    ...
    public void deployContracts(String cbcAddress) throws Exception {
        ...
        this.erc721 = ERC721RemoteBlockchain.deploy(this.web3j, this.tm, this.gasProvider, name, symbol, TOKEN_URI).send();
