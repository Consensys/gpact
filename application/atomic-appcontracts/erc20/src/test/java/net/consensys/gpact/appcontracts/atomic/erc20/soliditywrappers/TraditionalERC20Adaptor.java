...
public class TraditionalERC20Adaptor extends Contract {
    ...
    public static RemoteCall<TraditionalERC20Adaptor> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(TraditionalERC20Adaptor.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<TraditionalERC20Adaptor> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(TraditionalERC20Adaptor.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<TraditionalERC20Adaptor> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(TraditionalERC20Adaptor.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<TraditionalERC20Adaptor> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(TraditionalERC20Adaptor.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
