...
public class SfcErc20BridgeTestConfig extends AbstractWeb3Test {
    ...
    public void addOneErc20() throws Exception {
        ...
        SfcErc20Bridge bridge = SfcErc20Bridge.deploy(this.web3j, this.tm, this.freeGasProvider, dummySfcCbc).send();
        ...
        TransactionReceipt txr =
                bridge.addContractFirstMapping(thisBcTokenContract, otherBcId, otherTokenContract, thisBcMassC).send();
        List<SfcErc20Bridge.TokenContractConfigEventResponse> configEvents = bridge.getTokenContractConfigEvents(txr);
        ...
        SfcErc20Bridge.TokenContractAddressMappingChangedEventResponse mappingChangedEvent = mappingChangedEvents.get(0);
