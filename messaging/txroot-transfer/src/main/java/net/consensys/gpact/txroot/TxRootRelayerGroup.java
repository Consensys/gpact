...
public class TxRootRelayerGroup {
  ...
  public void loadContractForBlockchain(Credentials creds, BlockchainInfo bcInfo, String txRootContract) throws Exception {
    ...
    TxRootRelayer manager = new TxRootRelayer(
  ...
  public void publishReceiptRoot(BlockchainId publishingFrom,  byte[] transactionReceiptRoot, List<BlockchainId> blockchainsToPublishTo) throws Exception {
    ...
    for (BlockchainId bcId: blockchainsToPublishTo) {
      ...
      transactionReceiptCompletableFutures[i++] = relayer.addTransactionReceiptRootToBlockchainAsyncPart1(signed, publishingFrom, transactionReceiptRoot);
    }
