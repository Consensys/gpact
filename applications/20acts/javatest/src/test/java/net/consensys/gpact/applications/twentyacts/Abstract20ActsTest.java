...
abstract public class Abstract20ActsTest extends AbstractExampleTest {
    ...
    protected void deployAndSetup() throws Exception {
        ...
        TwentyActsExampleSystemManager exampleManager = new TwentyActsExampleSystemManager(tempPropsFile);
        ...
        this.depChainAErc20.deployErc20Contract(chainAName, chainASymbol, chainAInitialSupply, chainAErc20Owner.getAddress());
        ...
        this.depChainBErc20.deployErc20Contract(chainBName, chainBSymbol, chainBInitialSupply, chainBErc20Owner.getAddress());

        // Connect the chain A and chain B contracts together so there is a bridge.
        this.depChainA20Acts.addRemoteErc20(depChainAErc20.getErc20ContractAddress(), chainB.bcId, depChainBErc20.getErc20ContractAddress());
        this.depChainB20Acts.addRemoteErc20(depChainBErc20.getErc20ContractAddress(), chainA.bcId, depChainAErc20.getErc20ContractAddress());
    ...
    protected void setupBalances() throws Exception {
        ...
        this.lp1ChainBErc20.erc20Approve(lp1ChainB20Acts.getCbcContractAddress(), BigInteger.valueOf(LP1START));
        this.lp1ChainB20Acts.lpDeposit(lp1ChainBErc20.getErc20ContractAddress(), BigInteger.valueOf(LP1START));
    ...
    protected void checkHoldings(TwentyActsManager twentyActsManager, String account, String erc20, int deposits, int allocation, int withdrawals) throws Exception {
    ...
    protected void checkBalance(ERC20Manager erc20Manager, String account, int balance) throws Exception {
